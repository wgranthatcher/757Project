...
ax = sns.distplot(cover['customer_id'], color=color)
...
plt.figure(figsize=(8,6))
ax = sns.distplot(cover['product_parent'], color=color)
ax.yaxis.label.set_size(20)
ax.xaxis.label.set_size(20)
#plt.show()
...
'''
plt.figure(figsize=(8,6))
ax = sns.distplot(cover['star_rating'].dropna(), color=color)
ax.yaxis.label.set_size(20)
ax.xaxis.label.set_size(20)
#plt.show()
...
'''
plt.figure(figsize=(8,6))
ax = sns.countplot(cover['star_rating'], color=color)
ax.yaxis.label.set_size(20)
ax.xaxis.label.set_size(20)
#plt.show()
...
plt.figure(figsize=(8,6))
ax = sns.distplot(temp_votes['helpful_votes'], color=color, kde=False)
ax.yaxis.label.set_size(20)
ax.xaxis.label.set_size(20)
#plt.show()
...
plt.figure(figsize=(8,6))
ax = sns.distplot(temp_votes['total_votes'], color=color, kde=False)
ax.yaxis.label.set_size(20)
ax.xaxis.label.set_size(20)
#plt.show()
...
plt.figure(figsize=(8,6))
ax = sns.countplot(cover['product_id'], color=color)
ax.yaxis.label.set_size(20)
ax.xaxis.label.set_size(20)
#plt.show()
...
plt.figure(figsize=(8,6))
ax = sns.countplot(cover['product_category'], color=color)
ax.yaxis.label.set_size(20)
ax.xaxis.label.set_size(20)
#plt.show()
